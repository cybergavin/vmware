...
for line in `awk 'NR>1' $serverlist`
 do
   ...
   echo "  - {name: ${fields[0]}, ip: ${fields[1]}, gw: $my_gw, nm: $my_nm, nicpg: ${fields[3]}, cpu: ${fields[4]}, mem: $(( fields[5] * 1024 )), ds: ${fields[6]}, kd: ${fields[7]}, ld: ${fields[8]}, sd: ${fields[9]}, td: ${fields[10]}}"
done >> $varsfile
#
